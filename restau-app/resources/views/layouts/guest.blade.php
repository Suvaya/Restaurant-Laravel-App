...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="dark:bg-gray-200 shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center ">
            <div class="flex items-center justify-between">
                <a class="text-xl font-bold text-indigo-600 md:text-2xl hover:text-indigo-700"
                   href="#">
                    Ghoulsaucer's Restaurant
                </a>
                <!-- Mobile menu button -->
            ...
            <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class="text-sm font-bold text-indigo-600 md:text-2xl hover:text-indigo-700"
                   href="/">Home</a>
                <a class="text-sm font-bold text-indigo-600 md:text-2xl hover:text-indigo-700"
                   href="http://localhost:8000/categories">Category</a>
                <a href="#" class="text-sm font-bold text-indigo-600 md:text-2xl hover:text-indigo-700">Cart[{{ $count }}]</a>
...
{{--                   href="{{ route('frontend.menu.index') }}">Our Menu</a>--}}
